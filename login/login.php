 ...
 <script type="text/javascript" src="/md5.js"></script>
   <div class="container" id="login-block">
      ...
      <footer class="container">
        <p id="footer-text">Copyright &copy; UKK 2017 Koperasi Simpan Pinjam | Distributed by <a href="https://blogbugabagi.blogspot.com" target="_blank" rel="noopener noreferrer">BlogBugaBagi</a></p>
      </footer>
